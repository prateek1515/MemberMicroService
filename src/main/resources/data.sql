...
insert into member_premium (member_id,policy_id,paid_date,due_date,premium,late_payment,late_payment_charges) values(2,1,'2021-04-20','2021-03-02',12000.0,true,100);
...
insert into member_claim (policy_id,member_id,claim_id,provider_id,benefit_id,total_billed_amount,total_claimed_amount,claim_status,claim_description) values(1,2,4,1,201,90000.0,2300.0,' claimed','City hospital accident claim');
